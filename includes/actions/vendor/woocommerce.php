...
function qs_woocommerce($actions) {
  ...
  $actions["wc_customers"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["all customers", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_reports_customers"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["customers report", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_settings_general"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["general settings", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_settings_products"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["products settings", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_settings_shipping"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["shipping settings", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_settings_checkout"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["payment settings", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_settings_account"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["account settings", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_settings_email"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["email settings", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_settings_integration"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["integration settings", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_settings_advanced"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["advanced settings", "woocommerce"],
    "type" => "url",
  ...
  $actions["wc_settings_status_tasks"] = [
    ...
    "icon" => "dashicons-admin-tools",
    "tags" => ["schedules tasks", "woocommerce"],
    "type" => "url",
